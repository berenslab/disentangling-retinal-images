...
# bash script arguments: $1 experiment_folder $2 test config file
# Example call: 
# sh scripts/swapping_age_subspaces.sh outputs/classifier_model \
#   configs/configs_swapped_subspaces/test_age_classification.yaml

echo "classifier experiment folder" $1
...
echo "test classifier on swapped age subspaces"
$python_path src/evaluation/swapped_subspaces/test_age_classification.py -d $1 -c $2
