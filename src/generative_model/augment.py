...
from src.generative_model.building_blocks import (SmoothDownsample, SmoothUpsample,
                                                  identity)
...
class AugmentPipe(torch.nn.Module):
    def __init__(self, start_p, target, interval, fixed, batch_size):
        ...
        # Pixel blitting.
        self.xflip = 0.0  # Probability multiplier for x-flip.
        self.rotate90 = 0.0  # Probability multiplier for 90 degree rotations.
        ...
        self.rotate = 0.0  # Probability multiplier for arbitrary rotation.
        self.aniso = 0.0  # Probability multiplier for anisotropic scaling.
